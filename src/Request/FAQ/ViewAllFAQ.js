                            ...
                            >
                                <Tab eventKey="shipping" title="Shipping" style={{color:'#393F44', 'margin-top':'10px'}}>
                                    <ListGroup variant="flush">
                                        <ListGroup.Item action onClick={this.showFAQ}>What are the shipping fee and delivery timeline?</ListGroup.Item>
                                        <ListGroup.Item action onClick={this.showFAQ}>What does in-stock, backordered and made-to-order mean?</ListGroup.Item>
                                        <ListGroup.Item action onClick={this.showFAQ}>What is the last date to place an order to receive by Dec 24th?</ListGroup.Item>
                                    </ListGroup>
                                </Tab>
                                ...
                                <Tab eventKey="payment" title="Payment"  style={{color:'#393F44', 'margin-top':'10px'}}>
                                    <ListGroup variant="flush">
                                        <ListGroup.Item action onClick={this.showFAQ}>How do I find my order number?</ListGroup.Item>
                                        <ListGroup.Item action onClick={this.showFAQ}>Can I cancel my order?</ListGroup.Item>
                                        <ListGroup.Item action onClick={this.showFAQ}>Can I update my order?</ListGroup.Item>
                                        <ListGroup.Item action onClick={this.showFAQ}>Can I change my address?</ListGroup.Item>
                                    </ListGroup>
                                </Tab>
